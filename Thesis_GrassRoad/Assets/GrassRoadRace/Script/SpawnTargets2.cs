...
public class SpawnTargets2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (EnterArea.trigger_count == 2) // case2: moving with -z
        {
    ...
    void SpawnTarget_z()
    {
        ...
        for (int i = 0; i < maxTarget; i++)
        {
            ...
            if (EnterArea.trigger_count == 2) // -z case
            {
